...
public class SendAuthSMS {
	...
	public final static Logger logger = LoggerFactory
			.getLogger(SendAuthSMS.class);
	/**
	 * @param phonenum the object user's phone number
	 * @param auth the Authorization Number
	 */
	public SendAuthSMS(String phonenum, String auth){
		...
		result = restAPI.sendTemplateSMS(phonenum,"3361" ,new String[]{auth});
	...
	public static void main(String[] args) {
		...
		restAPI.setAccount("8a48b55146e1b04a0146f0de34b103d5", "eec123f0f961473da69f259c14feffea");// 初始化主帐号名称和主帐号令牌
		restAPI.setAppId("aaf98f8946eb7a5c0146f0ec134101a9");// 初始化应用ID
		result = restAPI.sendTemplateSMS("18616703467","3361" ,new String[]{""+Math.random()});
